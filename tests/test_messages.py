...
def test_css_e_servido() -> None:
    app = _app_com_rotas()
    # O estático sai em passthrough: sem fechar, o arquivo fica aberto até o
    # coletor de lixo (ResourceWarning).
    with app.test_client().get("/sharedauth/static/flash_messages.css") as resposta:
